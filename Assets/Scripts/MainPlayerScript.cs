...
public class MainPlayerScript : NetworkBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning(
                "Ground Layer is not set on "
                    + gameObject.name
                    + "! Player jump will not work correctly.",
                this
            );
        }
    }
    ...
    private void FixedUpdate()
    {
        ...
        if (MatchManager.Instance != null && !MatchManager.Instance.CanPlayerMove(OwnerClientId))
        {
    ...
    private void CheckGround()
    {
        ...
        else if (capsuleCollider != null)
        {
            ...
            float feetOffset =
                capsuleCollider.center.y - capsuleCollider.height / 2f + capsuleCollider.radius;
